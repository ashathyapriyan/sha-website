...
const img = (q: string) => {
  if (q.includes('artificial') || q.includes('robot') || q.includes('law') || q.includes('rocket') || q.includes('galaxy') || q.includes('moon')) return '/images/ai.png';
  if (q.includes('computer') || q.includes('usb') || q.includes('quantum') || q.includes('code') || q.includes('css') || q.includes('network') || q.includes('server') || q.includes('api') || q.includes('html')) return '/images/web.png';
  if (q.includes('marketing') || q.includes('analytics') || q.includes('video')) return '/images/marketing.png';
